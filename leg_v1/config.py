...
class Config:
    def __init__(self):
        ...
        self.leg_lf = LegDimensions(leg_index=1, name="left_front", upper_id=1, lower_id=2, inner_id=3, horizontal_inner=203)
        self.leg_rf = LegDimensions(leg_index=2, name="right_front", upper_id=4, lower_id=5, inner_id=6, horizontal_inner=193)
        self.leg_lh = LegDimensions(leg_index=3, name="left_hind", upper_id=7, lower_id=8, inner_id=9, horizontal_inner=408)
        self.leg_rh = LegDimensions(leg_index=4, name="right_hind", upper_id=10, lower_id=11, inner_id=12, horizontal_inner=311)
...
class LegDimensions:
    def __init__(self, leg_index, name, upper_id, lower_id, inner_id, horizontal_inner):
        ...
        self.c_e_offset = 1.03 # 59°, bell crank angle
